...
import 'package:flutter_demo_01/ui/widgets/chat_top_bar.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter_demo_01/ui/widgets/message_bubble.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  void checkAndUpdateLastMessageSeen(
    ...
    if (lastMessage.seen == false && lastMessage.senderId != myUserId) {
      ...
      Chat updatedChat = Chat(chatId, myUserId, otherUserId, lastMessage);
  ...
  void sendMessage(String myUserId) {
    ...
    Chat updatedChat = Chat(chatId, myUserId, otherUserId, message);
